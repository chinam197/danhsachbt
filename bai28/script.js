...
var lyric =`{
  ...
  "timestamp": 1695572597026
}`;

lyric = JSON.parse(lyric).data.sentences;


var singerInfo = `<h1>Ca sĩ: Thành Đạt</h1>
                  <h1>Ca khúc: học javascript</h1> `;
var songInner = document.querySelector(".lyric");

var karaokeInside = function(){
   var containerKaraoke = document.querySelector(".container-karaoke");
  containerKaraoke.classList.add("show");
  
singer.innerHTML = singerInfo;
songInner.innerHTML = " ";
  var exit = document.querySelector(".exit");
  exit.addEventListener("click",function(){
    containerKaraoke.classList.remove("show");
    singer.innerHTML = "";

  });
}
var singer = document.querySelector(".singer");
var karaoke = function(currentTime){
currentTime*=1000;

var index = lyric.findIndex(function(items,i){
var word = items.words;
return (
    currentTime >= word[0].startTime &&
    currentTime <= word[word.length - 1].endTime
  );
});
...
if( index !== -1){
    singer.innerHTML = "";
    songInner.innerHTML = "";
    var pLyric2 = document.createElement("p");
    pLyric2.classList.add("karaoke-word");
          lyric[index].words.forEach(function(text){
 var karaokeText = document.createElement("span");
 karaokeText.classList.add("karaoke-word");
 karaokeText.innerText = text.data + " ";
pLyric2.append(karaokeText);

});

songInner.append(pLyric2);
var p = document.createElement("p");
lyric[index+1].words.forEach(function(text){
    
    var karaokeText = document.createElement("span");
    karaokeText.classList.add("karaoke-word");
    karaokeText.innerText = text.data + " ";
   p.append(karaokeText);
   });
songInner.append(p);
}

};
var btnSing = document.querySelector(".click-sing");
btnSing.addEventListener("click",karaokeInside);